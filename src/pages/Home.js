                    ...
                    <View style={styles.conteudo}>
                        ...
                        {locais.map(local => (
                            <TouchableOpacity key={local.id_local} style={{
                                ...
                                height: 150,
                                marginTop: 10,
                            }} onPress={() => navigation.navigate('local', { local: local })}>
                                <Image style={{
                                    width: '100%',
                                    height: '100%'
                                ...
                                <View style={{
                                    ...
                                    <Text style={styles.p2}>{local.previa}</Text>
                                </View>
                            </TouchableOpacity>
                        ))}
                        ...
                        {/* <FlatList data={cards2} renderItem={({ item }) =>
                            <TouchableOpacity style={{
                                ...
                                height: 150,
                                marginTop: 10,
                            }} onPress={() => navigation.navigate('locais', { local: local })}>
                                <Image style={styles.img} source={local.image} />
                                <View style={styles.topText}>
                                    <Text style={styles.h2}>{local.titulo}</Text>
                                    <Text style={styles.p2}>{local.previa}</Text>
                                </View>
                            </TouchableOpacity>
                        } /> */}
